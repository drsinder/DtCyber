...
extern char printDir[];			//drs
extern char printApp[];			//drs
extern long autoRemovePaper;	//drs
extern char autoDateString[40];	//drs
extern char autoYearString[10];
extern bool autoDate;			//drs
